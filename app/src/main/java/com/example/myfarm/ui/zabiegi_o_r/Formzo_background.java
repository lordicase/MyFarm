...
public class Formzo_background extends AsyncTask<String, Void, String> {

    Context context;
    public Formzo_background(Context ctx) {
        this.context=ctx;
    }
    ...
    protected void onPostExecute(String s) {
        if (s.contains("A")) {
            Glowna.page=3;
            Toasty.success(context.getApplicationContext(), "Zabieg ochrony roślin został dodany pomyślnie!", Toast.LENGTH_LONG).show();
    ...
    protected String doInBackground(String... voids) {
        ...
        String user = voids[7];
        String regURL = "https://mzsk.pl/MYFARM/mobilna/dodaj_z_o_r.php";
