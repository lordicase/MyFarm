...
public class Formp_background extends AsyncTask<String, Void, String> {

    Context context;
    public Formp_background(Context ctx) {
        this.context=ctx;
    }
    ...
    protected void onPostExecute(String s) {
        if (s.contains("A")) {
            Glowna.page=5;
            Toasty.success(context.getApplicationContext(), "Pracownik został dodany pomyślnie!", Toast.LENGTH_LONG).show();
            ...
            Toasty.error(context.getApplicationContext(), "Błąd podczas dodawania pracownika, proszę spróbować później...", Toast.LENGTH_LONG).show();
        }
    ...
    protected String doInBackground(String... voids) {
        ...
        String user = voids[4];
        String regURL = "https://mzsk.pl/MYFARM/mobilna/dodaj_p.php";
