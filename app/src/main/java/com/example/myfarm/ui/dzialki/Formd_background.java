...
public class Formd_background extends AsyncTask<String, Void, String> {

    Context context;
    public Formd_background(Context ctx) {
        this.context=ctx;
    }
    ...
    protected void onPostExecute(String s) {
        if (s.contains("A")) {
            Glowna.page=1;
            Toasty.success(context.getApplicationContext(), "Działka została dodana pomyślnie!", Toast.LENGTH_LONG).show();
            ...
            Toasty.error(context.getApplicationContext(), "Błąd podczas dodawania działki, proszę spróbować później...", Toast.LENGTH_LONG).show();
        }
    ...
    protected String doInBackground(String... voids) {
        ...
        String regURL = "https://mzsk.pl/MYFARM/mobilna/dodaj_d.php";
