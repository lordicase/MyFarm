...
public class Formzb_background extends AsyncTask<String, Void, String> {

    Context context;

    public Formzb_background(Context ctx) {
        this.context=ctx;
    }
    ...
    protected void onPostExecute(String s) {
         ...
         if (s.contains("A")) {
            Glowna.page=6;
             Toasty.success(context.getApplicationContext(), "Wpis zmieniony pomyślnie!", Toast.LENGTH_LONG).show();
            ...
            context.startActivity(przeniesienie);
             ...
             Toasty.error(context.getApplicationContext(), "Błąd podczas zmiany wpisu, proszę spróbować później...", Toast.LENGTH_LONG).show();
        }
    ...
    protected String doInBackground(String... voids) {
        ...
        String id = voids[15];
        String regURL = "https://mzsk.pl/MYFARM/mobilna/zmien_b.php";
