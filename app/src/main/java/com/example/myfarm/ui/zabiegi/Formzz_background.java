...
public class Formzz_background extends AsyncTask<String, Void, String> {

    Context context;
    public Formzz_background(Context ctx) {
        this.context=ctx;
    }
    ...
    protected void onPostExecute(String s) {
        if (s.contains("A")) {
            Glowna.page=2;
            Toasty.success(context.getApplicationContext(), "Zabieg agrotechniczny został zmieniony pomyślnie!", Toast.LENGTH_LONG).show();
    ...
    protected String doInBackground(String... voids) {
        ...
        String user = voids[4];
        String id = voids[5];
        String regURL = "https://mzsk.pl/MYFARM/mobilna/zmien_z.php";
